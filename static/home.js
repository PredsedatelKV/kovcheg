import { get, post, iconHtml } from "/static/api.js?v=40";

import { openAssistantChat } from "/static/pages/assistant.js?v=40";

import { playUISound } from "/static/pages/settings.js?v=40";
...
export async function renderHome(root) {
  ...
  if (settingsBtn) settingsBtn.addEventListener("click", (ev) => {
    ev.stopPropagation();
    import("/static/pages/settings.js?v=40").then((m) => m.openSettings()).catch(function() {});
  });
