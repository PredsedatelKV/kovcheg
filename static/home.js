import { get, post, iconHtml } from "/static/api.js?v=254";

import { openAssistantChat } from "/static/pages/assistant.js?v=254";
...
export async function renderHome(root) {
  ...
  if (settingsBtn) settingsBtn.addEventListener("click", (ev) => {
    ev.stopPropagation();
    import("/static/pages/settings.js?v=254").then((m) => m.openSettings()).catch(function() {});
  });
