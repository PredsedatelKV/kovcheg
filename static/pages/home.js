import { get, post, iconHtml } from "/static/api.js?v=253";

import { openAssistantChat } from "/static/pages/assistant.js?v=253";
...
${bannerCarousel(data.banners)}
  ...
  if (settingsBtn) settingsBtn.addEventListener("click", (ev) => {
    ev.stopPropagation();
    import("/static/pages/settings.js?v=253").then((m) => m.openSettings()).catch(function() {});
  });
